...
public class ShopGameController extends BaseController {
    ...
    @PreAuthorize("@ss.hasRole('shop_owner') and @ss.hasPermi('shop:game:list')")
    ...
    @PreAuthorize("@ss.hasRole('shop_owner') and @ss.hasPermi('shop:game:query')")
    @GetMapping("/admin/game/{gameId}")
    public AjaxResult adminGameDetail(@PathVariable Long gameId) {
        return success(gameService.selectGameById(gameId));
    }

    @PreAuthorize("@ss.hasRole('shop_owner') and @ss.hasPermi('shop:game:add')")
    ...
    @PreAuthorize("@ss.hasRole('shop_owner') and @ss.hasPermi('shop:game:edit')")
    ...
    @PreAuthorize("@ss.hasRole('shop_owner') and @ss.hasPermi('shop:game:remove')")
